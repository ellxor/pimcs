...
def generate_config(system: Dicke, boson_dim: int, tspan: [float], e_count: int, ntraj: int,
    ...
    string_builder += f"\t.InitialJ = {system.diagonal_heff_j},\n"
    string_builder += f"\t.InitialM = {system.diagonal_heff_m},\n"
...
def build_executable():
    ...
    assert os.system(
        f"cc -c -o main-{hash_str}.o -std=c11 -pthread -fPIC -O3 -march=native -ffast-math pimcs/c_backend/main_diagonal_heff.c") == 0
